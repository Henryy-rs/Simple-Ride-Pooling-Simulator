...
parser.add_argument('--matching_method', type=str, default='greedy', choices=['greedy', 'radian'], help='matching method')
...
parser.add_argument('--max_requests', type=int, default=None, help='max number of requests in a step')
